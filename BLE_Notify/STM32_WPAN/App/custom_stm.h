...
{
  /* myChar1 */
  CUSTOM_STM_MYCHAR1_WRITE_EVT,
  /* myNotify */
  CUSTOM_STM_MYNOTIFY_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_MYNOTIFY_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeMychar1;
extern uint16_t SizeMynotify;
